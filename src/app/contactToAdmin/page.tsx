...
export default function ManageVendor() {
  ...
  return (
    <>
      <div className="h-screen flex flex-col items-center  p-4 text-[#4C4343] text-lexend">
        <Image src={Logo} alt="Bamboo Family Market" />
        <form
          onSubmit={handleSend}
          className="space-y-4 bg-white py-4 px-4 rounded-2xl"
        >
          <div className="m-2 flex items-center gap-6">
            <label className="block font-normal mb-1 ">Contacted from : </label>
            <input
              type="text"
              name="from_username"
          ...
          <div className="m-2 flex gap-28">
            <label className="block font-normal mb-1 ">Details : </label>
            <textarea
              name="detail"
          ...
          <div className="m-2 flex items-center gap-20">
            <label className="block font-normal mb-1 ">Contact at : </label>
            <input
              type="text"
              name="contact_to_en"
            ...
            <Dialog.Panel className="w-full max-w-5xl max-h-[80vh] rounded-2xl bg-white p-8 shadow-lg overflow-y-auto scrollbar-hide">
              ...
              <Dialog.Description className="text-gray-700 text-lg leading-relaxed space-y-6">
                <div>
                  ...
                  <p>
                    This website may temporarily collect users&#39; personal
                    data, such as usernames, email addresses, phone numbers,
                    LINE IDs, or other necessary contact information to provide
                    services. This data will be stored only for the required
                    period and securely deleted when no longer necessary.
                  </p>
                  <ul className="list-inside pl-4 space-y-1 text-gray-600">
                    <li>
                      Use of Data: The collected data will be used solely for
                      the purpose of providing services and will not be
                      disclosed to third parties without user consent.
                    </li>
                    <li>
                      Access to Data by Administrators: User data may be
                      accessed by administrators (Admin) for account management,
                      system maintenance, and technical support purposes.
                      Administrators are responsible for ensuring the security
                      and confidentiality of the data.
                    </li>
                    <li>
                      Retention Period: Data will be automatically deleted
                      within a specified period after the relevant process has
                      been completed.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-inside pl-4 space-y-1 text-gray-600">
                    ...
                    <li>
                      ...
                      cyberattacks, natural disasters, or issues caused by
                ...
                <div>
                  ...
                  <ul className="list-inside pl-4 space-y-1 text-gray-600">
                    <li>
                      Right to Access: Users may request access to their
                      personal data stored on the website, such as phone numbers
                      or LINE IDs.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-inside pl-4 space-y-1 text-gray-600">
                    <li>
                      Consent to the collection and use of personal data, such
                      as phone numbers and LINE IDs, as outlined in this policy.
                    </li>
                    <li>
